                        ...
                        <div className="row justify-content-between">
                            <div className='col-xl-4 col-lg-4 col-sm-6 mb-3'>
                                <div className='footer-widget mb-3'>
                                    <a href="#" className="logo">Luxe<span>Hub</span></a>
                                </div>
                                <div className="f-contact">
                                    <ul>
                                        <li className='mb-3'>
                                            <i className="ri-phone-line"></i>
                                            <span>1800-121-3637 <br />
                                                +91-7052-101-786</span>
                                        </li>
                                        <li className='mb-3'>
                            ...
                            <div className='col-xl-4 col-lg-4 col-sm-6 mb-3'>
                                ...
                                <div className="footer-link">
                                    <div className="subricbe position-relative">
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className='col-lg-6 col-md-6 copyright-text'>
                                Copyright © 2025. All Rights Reserved By <a href="#">Krisha</a>
                            </div>
